    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          _AppCard(
            appName: '河图',
            description: '精美图片素材免费下载',
            logoAsset: 'assets/images/applogo/hetu_logo.png',
            appUrl: 'https://www.hetu.asia',
          ),
          SizedBox(height: 16),
          _AppCard(
            appName: '河图艺术',
            description: '经典艺术作品高清下载',
            logoAsset: 'assets/images/applogo/hetuart_logo.png',
            appUrl: 'https://www.hetu.asia',
          ),
        ],
      ),
